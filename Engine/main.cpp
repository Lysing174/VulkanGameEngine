...
private:
    void initWindow() {
        ...
        glfwSetWindowSizeCallback(window, MyVulkan::onWindowResized);
    }
...
void MyVulkan::onWindowResized(GLFWwindow* window, int width, int height) {
    if (width == 0 || height == 0) return;

    MyVulkan* app = reinterpret_cast<MyVulkan*>(glfwGetWindowUserPointer(window));
